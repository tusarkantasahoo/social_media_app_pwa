...
export const allCollegeData = [
  ...
  },
  {
    ...
    type: "state",
    contact:
      "Information Office Ph: 2457 - 2227 Main Campus Ph:+9133-24146666 Salt Lake Campus Ph: +9133-2335 5215",
    website: "www.jaduniv.edu.in",
    email: "vc@jadavpuruniversity.in registrar@jadavpuruniversity.in",
    coursesAndFees:
      "B.Tech - Rs.2,400 (1st Year Fees);B.Pharm - Rs.2,400 (1st Year Fees)B.Ed - Rs. 15,260 (Total Fees); B.Sc - Rs.2,400 (1st Year Fees)B.Arch - Rs.12,000 (Total Fees)BA - Rs.2,400 (1st Year Fees)B.P.Ed - Rs.2,400 (1st Year Fees) Master of Computer Applications [M.C.A]",
    cutoff: "",
    admission:
  ...
  },
  {
    ...
    contact: "033-24678300, 24678301, 24678302, 24678303",
  ...
  },
  {
    ...
    address: "Main Campus & Office - 11 Lower Rawdon Street, Kolkata - 700020 West Bengal, India ",
    ...
    contact: "033-24755070, 24767340",
    website: "www.jdbikolkata.in",
    email: "jdbiadmin@jdbikolkata.in",
    coursesAndFees: "BBA {Hons.} - Rs.2.01 Lakhs (1st Year Fees) B.Com {Hons.} - Rs.1.5 Lakhs (1st Year Fees) B.Sc {Hons.} - Rs.1.75 Lakhs (1st Year Fees) PG Diploma - Rs.58,400 (Total Fees) M.Com - Rs.62,600 (1st Year Fees) M.Sc - Rs.84,200 (1st Year Fees) BBA - 2.44 Lakhs (1st Year Fees)",
    cutoff: "Eligible candidates need to appear for the Aptitude Test conducted by the college.",
    admission: "JD Birla Institute was founded in the year 1963 in Kolkata, West Bengal. The Institute is affiliated to Jadavpur University and is accredited by NAAC. The institute offers B.Sc (Honors) and B.Com with 40 and 250 seats respectively at the UG level. PG program includes M.Sc, M.Com and PG Diploma in Dietetic and Applied with 10, 30 and 15 seats respectively. Students could apply online and offline for admission to any UG/ PG course in JD Birla Institute. Applicants who have passed 10+2 or its equivalent qualifying examination from a recognized board with minimum 50% marks are eligible for B.Sc (Hons) course. To get admission in B.Com, candidates must have completed 10+2 with at least 55% marks. For M.Sc and PG Diploma program. candidates who have completed B.Sc (Honors) with 55% marks from Jadavpur University are considered eligible. For M.Com, a candidate must hold B.Com Degree with minimum 55% marks. Selection to B.Sc (Hons) is done on the basis of candidates’ merit in 10+2 and their score in aptitude test and personal interview round. Admission to B.Com is given as per candidates’ score in the qualifying examination and group discussion. Candidates are admitted to M.Sc and PG Diploma program on the basis of their merit in graduation and General Aptitude test. Selection of candidates in M.Com is done based on their percentage in Bachelor’s Degree course and score obtained in personal interview round.",
    examAccepted: "",
    facilities: "Library; Sports Complex; Computer Lab; Cafeteria; Hospital / Medical Facilities; Wi-Fi Campus; Auditorium; A/C Classrooms; Convenience Store",
    placements: "",
