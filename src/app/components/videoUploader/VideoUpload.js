    ...
    return (
      <>
        ...
        <div className="row">
            ...
            <p style={{fontSize: "25px",marginLeft: "20px"}}>Or have a link to share</p>
            </div>
          ...
          <div style={{ }}>
            <input
              ...
              style={{ width: "90%", height: "50px", marginLeft: "5%",border:"0.5px solid black",outline:"0" }}
            ></input>
        ...
        <div className="row" style={{ textAlign: "left" }}>
          <div style={{ padding: "10px" }}>
            <input
              ...
              style={{ width: "90%", height: "50px", marginLeft: "5%",outline:"0",border:"0.5px solid black" }}
            ></input>
          </div>
        </div>
        <button 
